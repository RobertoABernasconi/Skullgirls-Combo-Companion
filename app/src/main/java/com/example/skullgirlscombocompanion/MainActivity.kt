...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageButton0 = findViewById<ImageButton>(R.id.imageButton1)
        imageButton0.setOnClickListener(listener)
        ...
        val imageButton7 = findViewById<ImageButton>(R.id.imageButton8)
        imageButton7.setOnClickListener(listener)
        val imageButton8 = findViewById<ImageButton>(R.id.imageButton9)
        imageButton8.setOnClickListener(listener)
        val imageButton9 = findViewById<ImageButton>(R.id.imageButton10)
        imageButton9.setOnClickListener(listener)
        val imageButton10 = findViewById<ImageButton>(R.id.imageButton11)
        imageButton10.setOnClickListener(listener)
        val imageButton11 = findViewById<ImageButton>(R.id.imageButton12)
        imageButton11.setOnClickListener(listener)
        val imageButton12 = findViewById<ImageButton>(R.id.imageButton13)
        imageButton12.setOnClickListener(listener)
        val imageButton13 = findViewById<ImageButton>(R.id.imageButton14)
        imageButton13.setOnClickListener(listener)
        val imageButton14 = findViewById<ImageButton>(R.id.imageButton15)
        imageButton14.setOnClickListener(listener)
        val imageButton15 = findViewById<ImageButton>(R.id.imageButton16)
        imageButton15.setOnClickListener(listener)
        val imageButton16 = findViewById<ImageButton>(R.id.imageButton17)
